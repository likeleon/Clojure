...
(defn pegged?
  "Does the positioin have a peg in it?"
  [board pos]
...
;(println (valid-moves my-board 1))
;(println (valid-moves my-board 6))
;(println (valid-moves my-board 11))
;(println (valid-moves my-board 5))
;(println (valid-moves my-board 8))
...
;(println (valid-move? my-board 8 4))
;(println (valid-move? my-board 1 4))
